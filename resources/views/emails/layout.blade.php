...
<head>
    ...
    <title>Fast and Female Geneva</title>
</head>
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; width: 100%;">
                    ...
                    <tr>
                        <td align="center" style="background-color: #80081C; padding: 28px 20px; border-radius: 8px 8px 0 0;">
                            <img src="{{ $message->embed(public_path('images/logo-ffgva.png')) }}" alt="Fast and Female Geneva" style="max-width: 200px; height: auto;">
                        </td>
                    </tr>
                    {{-- Content --}}
                    <tr>
                    ...
                    <tr>
                        <td align="center" style="background-color: #80081C; padding: 18px 20px; border-radius: 0 0 8px 8px;">
                            <p style="margin: 0; color: #ffffff; font-size: 13px;">
                                Fast and Female Geneva &mdash; <a href="https://www.ffgva.ch" style="color: #ffffff; text-decoration: underline;">www.ffgva.ch</a>
                            </p>
                        </td>
                    </tr>
                </table>
