...
@section('content')
    ...
    <p style="text-align: center; margin-bottom: 20px;">
        <a href="{{ $confirmUrl }}" style="display: inline-block; background-color: #80081C; color: #ffffff; font-weight: 600; font-size: 15px; padding: 12px 32px; border-radius: 6px; text-decoration: none;">
