...
@section('content')
    ...
    <p style="margin-bottom: 16px;">Un petit rappel pour l'événement <strong>{{ $event->title }}</strong> auquel tu es inscrite.</p>
    ...
    <p style="font-size: 13px; color: #666;">À bientôt sur le vélo !</p>
@endsection
