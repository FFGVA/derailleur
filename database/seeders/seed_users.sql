...
INSERT IGNORE INTO `users` (`name`, `email`, `password`, `role`, `member_id`, `created_at`, `updated_at`)
VALUES
    ('Admin FFGVA', 'admin@ffgva.ch', '$2y$12$k9NBklaetSlx0PieysDXJecCfq0.gMmQlqWSijNRmb02Hfu8FKhQq', 'A', NULL, NOW(), NOW()),
