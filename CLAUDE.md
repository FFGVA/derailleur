...
## Data model
- **Member**: member_number (4-digit high-watermark), first_name, last_name, email, statuscode (D/A/I/P/N/E), is_invitee, metadata (JSON), activation_token, membership_start/end, modified_by_id → users
